...
export function DequeueNotifications():Promise<Array<notify.Event>>;
...
export function ShowNotification(arg1:notify.Event):Promise<void>;

export function StartNotify():Promise<void>;

export function StartReporting():Promise<void>;

export function Status():Promise<main.StatusDTO>;

export function StopNotify():Promise<void>;
